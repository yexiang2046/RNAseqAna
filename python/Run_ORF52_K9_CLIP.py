...
Para = get_para(configfile="config_ORF52_K9_CLIP.txt")
thread_num = Para[0]
align_idx = Para[1]
out_dir = Para[2]
trimmer_dir = Para[3]
...
if (pair_end == "Yes"):
    for i in range(sample_num):
        ...
        #print(["./bash/step1_reads_trimming.sh", thread_num, align_idx, out_dir, trimmer_dir, alignment_dir, pair_end, trimmed_path, fastq_files[i*2], fastq_files[i*2+1]])
else:
...
GTF = "GRCh38_HHV8.annotation.gtf"
GTF_file = os.path.join(out_dir, GTF)
count_file = "ORF52_K9_CLIP_RNA_count.txt"
